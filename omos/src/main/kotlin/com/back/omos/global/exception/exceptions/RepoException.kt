 ...
 *
 * <p>{@link RepositoryErrorCode} 의 값과 (optional) 내부 로그 메시지를 담습니다.
 *
 * <p><b>상속 정보:</b><br>
 * {@link BaseException} 의 구현 클래스입니다.
 *
 * <p><b>주요 생성자:</b><br>
 * {@code RepositoryException(RepositoryErrorCode errorCode)} <br>
 * RepositoryErrorCode만 매개변수로 받도록 강제합니다. 내부 로그 메시지를 담지 않는 예외를 생성합니다. <br>
 * {@code RepositoryException(RepositoryErrorCode errorCode, String logMessage)} <br>
 * RepositoryErrorCode와 함께 내부 로그 메시지를 담는 예외를 생성합니다. <br>
 * {@code RepositoryException(RepositoryErrorCode errorCode, String logMessage, String clientMessage)} <br>
